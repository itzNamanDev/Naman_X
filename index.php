<HTML>
    <TITLE> HACKED BY NAMAN </TITLE>
    
    <FONT FACE=Courier>
      <center><tt><h1 style="text-shadow: 0 0 0.5em red"><center class="Text" >Hacked By NAMAN</center></h1></tt>
    <FONT FACE=Courier>
    <marquee align="center" scrollamount="6" width="560"><font color="red" size="5"class= "Animation" >By twitter.com/AlienNaman </h1></tt>
    </marquee>
    ...
    <!--
    var tl=new Array("C:/Users/HindutvaWarriors",
    "Your site has been defaced by Naman",
    "Fuck Off!" , 
